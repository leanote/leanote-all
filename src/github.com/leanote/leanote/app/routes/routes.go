...
func (_ tBaseController) E404() string {
...
func (_ tFile) UploadBlogLogo() string {
	args := make(map[string]string)
...
func (_ tFile) UploadAvatar() string {
	args := make(map[string]string)
...
func (_ tUser) ReSendActiveEmail() string {
	args := make(map[string]string)
...
func (_ tAuth) FindPassword() string {
	args := make(map[string]string)
...
func (_ tIndex) Default() string {
	args := make(map[string]string)

	return revel.MainRouter.Reverse("Index.Default", args).Url
}

func (_ tIndex) Index() string {
	args := make(map[string]string)
...
func (_ tNote) ListTrashNotes() string {
	args := make(map[string]string)
...
func (_ tAlbum) Index() string {
	args := make(map[string]string)

	return revel.MainRouter.Reverse("Album.Index", args).Url
}

func (_ tAlbum) GetAlbums() string {
	args := make(map[string]string)
...
func (_ tNotebook) GetNotebooks() string {
	args := make(map[string]string)
...
func (_ tAdminData) Index() string {
	args := make(map[string]string)

	return revel.MainRouter.Reverse("AdminData.Index", args).Url
}

func (_ tAdminData) Backup() string {
	args := make(map[string]string)
...
func (_ tAdminSetting) Email() string {
	args := make(map[string]string)

	return revel.MainRouter.Reverse("AdminSetting.Email", args).Url
}

func (_ tAdminSetting) Blog() string {
	args := make(map[string]string)
...
func (_ tAdminSetting) Demo() string {
	args := make(map[string]string)
...
func (_ tAdminSetting) SubDomain() string {
	args := make(map[string]string)
...
func (_ tAdminEmail) Email() string {
	args := make(map[string]string)

	return revel.MainRouter.Reverse("AdminEmail.Email", args).Url
}

func (_ tAdminEmail) Blog() string {
	args := make(map[string]string)
...
func (_ tAdminEmail) Demo() string {
	args := make(map[string]string)
...
func (_ tAdminEmail) ToImage() string {
	args := make(map[string]string)
...
func (_ tAdminEmail) Template() string {
	args := make(map[string]string)
...
func (_ tApiUser) GetSyncState() string {
	args := make(map[string]string)

	return revel.MainRouter.Reverse("ApiUser.GetSyncState", args).Url
}

func (_ tApiUser) UpdateLogo() string {
	args := make(map[string]string)
...
func (_ tApiNotebook) GetNotebooks() string {
	args := make(map[string]string)
...
func (_ tApiNote) GetTrashNotes() string {
	args := make(map[string]string)
...
func (_ tMemberGroup) Index() string {
	args := make(map[string]string)
...
func (_ tMemberIndex) Index() string {
	args := make(map[string]string)
...
func (_ tMemberBlog) Single() string {
	args := make(map[string]string)

	return revel.MainRouter.Reverse("MemberBlog.Single", args).Url
}

func (_ tMemberBlog) Theme() string {
	args := make(map[string]string)
...
func (_ tMemberBlog) ImportTheme() string {
	args := make(map[string]string)
...
func (_ tMemberBlog) NewTheme() string {
	args := make(map[string]string)
